...
std::vector<card> initializeChanceCards() {
    ...
    std::vector<card> chanceCards = {
        ...
        {"moveNearest", "Advance to the nearest Railroad. If unowned, you may buy it from the Bank", {{"destination","railroad"}}},
        {"moveNearest", "Advance to the nearest Railroad. If unowned, you may buy it from the Bank", {{"destination","railroad"}}},
        {"moveNearest", "Advance token to nearest Utility. If unowned, you may buy it from the Bank", {{"destination","utility"}}},
        {"jailFree", "Get Out of Jail Free", {}},
        {"move", "Go Back 3 Spaces", {{"position","-3"}}},
